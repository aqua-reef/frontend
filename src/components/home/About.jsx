      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-lg text-gray-500">
            At AquaReef, we're passionate about bringing the wonders of the
            underwater world into your home. With over a decade of experience,
            we specialize in creating stunning aquariums that serve as living
            works of art.
          </p>
        ...
        <div className="mt-10 lg:mt-0">
          <img
            ...
            src="https://wallpapercave.com/wp/wp9140838.jpg"
            alt="Beautiful aquarium setup"
          />
        </div>
      </div>
    </div>
