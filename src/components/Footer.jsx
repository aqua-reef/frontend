      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4">Specializing in marine tanks, planted tanks, freshwater species, exotic fish, and all aquarium accessories.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#shop" className="hover:text-blue-300">Shop</Link></li>
